...
## Project Structure
    ...
    ├── testapiautocatalog_107182  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_107182`
...
2. Clone this repo and `cd testapiautocatalog_107182`
